                ...
                <div class="modal fade" id="paymentModal<?= $cr['credit_id'] ?>" tabindex="-1">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <form method="POST" action="?r=payment/record" id="paymentForm<?= $cr['credit_id'] ?>" data-validate-form>
                        <div class="modal-body">
                          ...
                          <div class="mb-3">
                            ...
                            <small class="text-muted"><i class="fa fa-info-circle"></i> Maximum: RWF <?= number_format($balance, 2) ?></small>
                          </div>
