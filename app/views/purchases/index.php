...
.page-header-purchase h2 {
  color: #10b981;
  font-size: 2rem;
  font-weight: 700;
}

.page-header-purchase p {
  color: #6b7280;
}

.page-header-purchase .header-icon {
  background: linear-gradient(135deg, #10b981 0%, #059669 100%);
  color: white;
  width: 50px;
  height: 50px;
...
body.dark-mode .page-header-purchase h2 {
  color: #34d399 !important;
}

body.dark-mode .page-header-purchase p {
  color: #9ca3af !important;
}

body.dark-mode .page-header-purchase .header-icon {
  background: linear-gradient(135deg, #064e3b 0%, #065f46 100%);
}

body.dark-mode .btn-new-purchase {
  background: linear-gradient(135deg, #064e3b 0%, #065f46 100%);
}

body.dark-mode .btn-new-purchase:hover {
...
<div class="container my-4">
  ...
  <div class="page-header-purchase">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
      ...
      <a class="btn btn-new-purchase btn-lg" href="?r=purchase/create">
  ...
  <?php
  // Ensure grouped_purchases is defined
  if (!isset($grouped_purchases)) {
    $grouped_purchases = [];
  }
    ...
    <div class="col-md-3 col-sm-6">
      <div class="stats-card-purchase warning shadow">
        <div class="card-body text-center p-4">
          ...
          <small class="opacity-75">RWF Spent</small>
        </div>
      </div>
    </div>
    <div class="col-md-3 col-sm-6">
          ...
          <?php else: ?>
            <?php foreach($grouped_purchases as $group): ?>
              ...
              <tr class="purchase-row">
                ...
                <td><?=number_format($p['unit_price'],2)?> RWF</td>
                <td><strong><?=number_format($p['total_price'],2)?> RWF</strong></td>
              ...
              <tr class="supplier-subtotal">
                ...
                <td class="fw-bold py-3" style="font-size: 1.05rem;">
                  <?=number_format($group['total'],2)?> RWF
                </td>
                <td></td>
              </tr>
            <?php endforeach; ?>
            ...
            <tr class="grand-total-row">
              ...
              <td class="fw-bold py-4" style="font-size: 1.3rem;">
                <?=number_format($grand_total,2)?> RWF
              </td>
              <td></td>
            </tr>
          <?php endif; ?>
