...
class Purchase extends Model {
    ...
    public function allByDateRange($start, $end) {
        $stmt = $this->db->prepare('SELECT p.*, s.name as supplier_name, pr.name as product_name FROM purchases p JOIN suppliers s ON p.supplier_id = s.supplier_id JOIN products pr ON p.product_id = pr.product_id WHERE p.purchase_date BETWEEN ? AND ? ORDER BY s.name, p.purchase_date DESC');
