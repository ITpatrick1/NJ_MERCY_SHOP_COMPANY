...
class Payment extends Model {
    ...
    public function recordPayment($credit_id, $amount_paid, $recorded_by, $remarks = '') {
        ...
        try {
            ...
            $stmt = $this->db->prepare('INSERT INTO credit_payments (credit_id, amount_paid, status, recorded_by, remarks) VALUES (?, ?, ?, ?, ?)');
            $stmt->execute([$credit_id, $amount_paid, 'pending', $recorded_by, $remarks]);
