        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!$error) {
                ...
                if ($foundSupplier) {
                    ...
                    $error = 'Supplier TIN not found. Please use an existing supplier.';
                }
            }
            ...
            if (!$error) {
                ...
                if ($foundProduct) {
                    ...
                    $error = 'Product name not found. Please use an existing product.';
                }
            }

            if (!$error && ($quantity <= 0 || $unit_price < 0)) {
                $error = 'Quantity must be > 0 and unit price must be valid.';
            }
