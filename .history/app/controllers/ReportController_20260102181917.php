...
class ReportController extends Controller {
    ...
    public function creditSales(){
        $this->ensure();
        $pdo = Database::pdo();
        $stmt = $pdo->query("SELECT cs.*, c.name as client_name, c.tin_number as client_tin, c.client_id FROM credit_sales cs JOIN clients c ON cs.client_id = c.client_id ORDER BY c.name, cs.date_issued DESC");
        $sales = $stmt->fetchAll();
