<div class="container mt-4">
  ...
  <div class="card p-3 shadow-sm border-0 mb-3">
    <form method="get" action="?r=purchase/index" class="d-flex flex-wrap gap-2 align-items-center">
  ...
  <div class="card p-3 shadow-sm border-0 mb-4">
    <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between">
      <form method="get" action="?r=purchase/exportCsv" class="d-flex align-items-center gap-2 mb-2 mb-md-0">
      ...
      <form method="get" action="?r=purchase/exportPdf" class="d-flex align-items-center gap-2">
