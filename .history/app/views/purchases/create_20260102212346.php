<div class="container mt-4" style="max-width:700px;">
  ...
  <div class="card p-4 shadow-sm border-0">
    ...
    <form method="post" id="purchaseForm" data-validate-form>
      <?php if (!empty($error)): ?>
      ...
      <div class="row g-3 mb-4">
        <div class="col-md-6">
          <label class="form-label"><i class="fa fa-truck"></i> Supplier Name <span class="text-danger">*</span>
          ...
          <div class="input-group">
            ...
            <input list="supplierNameOptions" 
                   name="supplier_name" 
                   class="form-control" 
        ...
        <div class="col-md-6">
          <label class="form-label"><i class="fa fa-id-card"></i> Supplier TIN <span class="text-danger">*</span>
          ...
          <div class="input-group">
            ...
            <input list="supplierTinOptions" 
                   name="supplier_tin" 
                   class="form-control" 
                   placeholder="Type supplier TIN"
                   data-validate="required|tin"
                   maxlength="9"
                   required>
          </div>
      ...
      <div class="mb-3">
        <div class="d-flex justify-content-between align-items-center mb-2">
          <label class="form-label mb-0"><i class="fa fa-box"></i> Products <span class="text-danger">*</span></label>
