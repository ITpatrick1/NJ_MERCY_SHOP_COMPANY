<div class="container mt-4" style="max-width:540px;">
  ...
  <div class="card p-4 shadow-sm border-0">
    ...
    <form method="post" id="purchaseForm" novalidate>
      ...
      <?php endif; ?>
      <div class="mb-3">
        <label class="form-label"><i class="fa fa-truck"></i> Supplier TIN
      ...
      <div class="mb-3">
        <label class="form-label"><i class="fa fa-box"></i> Product name
          <i class="fa fa-info-circle text-info ms-1" data-bs-toggle="tooltip" title="Type the product name; it will be matched automatically."></i>
        </label>
        <input list="productNameOptions" name="product_name" class="form-control" placeholder="Type product name" required>
        <datalist id="productNameOptions">
          <?php foreach($products as $p): ?>
            <option value="<?=htmlspecialchars($p['name'])?>"></option>
          <?php endforeach; ?>
        </datalist>
        <div class="invalid-feedback">Please type a valid product name.</div>
      </div>
      <div class="mb-3">
