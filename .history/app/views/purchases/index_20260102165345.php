        ...
        <?php else: ?>
          <?php foreach($grouped_purchases as $group): ?>
            ...
            <tr style="background-color: #fff3cd; border-left: 4px solid #856404;">
              <td colspan="5" class="text-end fw-bold" style="color: #856404;"><i class="fa fa-calculator"></i> Subtotal for <?=htmlspecialchars($group['supplier_name'])?>:</td>
          ...
          <tr style="background-color: #d4edda; border-left: 4px solid #155724;">
            <td colspan="5" class="text-end fw-bold fs-5" style="color: #155724;"><i class="fa fa-money-bill-wave"></i> GRAND TOTAL:</td>
