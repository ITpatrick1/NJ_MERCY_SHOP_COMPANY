      ...
      <table class="table table-bordered table-striped align-middle mb-0">
        ...
        <?php else: ?>
          <?php foreach($grouped_purchases as $group): ?>
            <!-- Supplier Header Row -->
            <tr class="table-primary border-start border-primary border-3">
              <td colspan="7" class="fw-bold">
                <i class="fa fa-truck"></i> <?=htmlspecialchars($group['supplier_name'])?>
              </td>
            </tr>
            ...
            <tr class="table-warning border-start border-warning border-3">
              <td colspan="5" class="text-end fw-bold">Subtotal for <?=htmlspecialchars($group['supplier_name'])?>:</td>
              <td class="fw-bold"><?=number_format($group['total'],2)?></td>
              <td></td>
            </tr>
          <?php endforeach; ?>
          <!-- Grand Total Row -->
          <tr class="table-success border-start border-success border-3">
