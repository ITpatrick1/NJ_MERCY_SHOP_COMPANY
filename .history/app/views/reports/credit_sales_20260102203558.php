                        ...
                        <form method="POST" action="?r=payment/record">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="mb-3">
                              ...
                              <small class="text-muted">You can pay partial amount or full balance</small>
                            </div>
                            
                            <div class="mb-3">
                              <label class="form-label">Remarks (Optional)</label>
                              <textarea name="remarks" class="form-control" rows="2" placeholder="Enter any payment remarks..."></textarea>
                            </div>
                          </div>
