    ...
    <div class="col-md-6">
      <div class="card month-selector-card border-0 h-100">
        <div class="card-body p-4">
          <form method="post" action="?r=report/profit&month=<?= htmlspecialchars($month ?? date('Y-m')) ?>" class="d-flex align-items-center gap-3 flex-wrap">
    ...
    <div class="col-12">
      <div class="card stat-card-profit border-0" style="border: 3px solid #8b5cf6 !important;">
        <div class="card-body p-4">
          ...
          <div class="display-3 fw-bold mb-3" style="color: #8b5cf6;">RWF <?=number_format($actualMoneyRemaining,2)?></div>
          <div class="border-top pt-3">
            <div class="row">
              <div class="col-md-3">
              ...
              <div class="col-md-3">
                <div class="d-flex flex-column">
                  ...
                  <strong style="color: #8b5cf6;">RWF <?=number_format($actualMoneyRemaining,2)?></strong>
                </div>
              </div>
            </div>
          </div>
          <div class="alert alert-info mt-3 mb-0">
            <i class="fa fa-info-circle"></i> <strong>Formula:</strong> 
            RWF <?=number_format($totalCapitalInput,2)?> (Capital) + 
            RWF <?=number_format($totalSalesMonth,2)?> (Sales) - 
            RWF <?=number_format($totalMoneyUsed,2)?> (Used) = 
            <strong>RWF <?=number_format($actualMoneyRemaining,2)?></strong>
          </div>
        </div>
      </div>
    </div>
