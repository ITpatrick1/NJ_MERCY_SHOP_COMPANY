  ...
  <div class="card search-card-credit p-4 mb-4">
    ...
    <div>
      <small style="color: white !important;">
        ...
        Showing <strong style="color: white !important;" id="visibleCount"><?= $totalCredits ?></strong> of 
        <strong style="color: white !important;" id="totalCount"><?= $totalCredits ?></strong> credit sales | 
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const tableRows = document.querySelectorAll('.credit-row');
  ...
  if (searchInput && tableRows.length > 0) {
    searchInput.addEventListener('input', function() {
      ...
      const tableBody = document.querySelector('.credit-row')?.parentElement;
      ...
      if (visibleRows === 0 && searchTerm !== '') {
        if (!noResultsRow) {
          ...
          noResultsRow.innerHTML = '<td colspan="9" class="text-center py-4"><i class="fa fa-search fa-2x text-muted mb-2"></i><br>No results found for "' + searchTerm + '"</td>';
          tableBody?.appendChild(noResultsRow);
        } else {
          noResultsRow.querySelector('td').innerHTML = '<i class="fa fa-search fa-2x text-muted mb-2"></i><br>No results found for "' + searchTerm + '"';
