        ...
        <?php if(!empty($_SESSION['user'])): ?>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end profile-dropdown" aria-labelledby="userDropdown">
              ...
              <li><a class="dropdown-item py-2" href="?r=profile/index"><i class="fa fa-user-circle text-primary me-2"></i> My Profile</a></li>
              <li><a class="dropdown-item py-2" href="?r=profile/edit"><i class="fa fa-user-edit text-success me-2"></i> Edit Profile</a></li>
              <li><hr class="dropdown-divider m-0"></li>
              <li><a class="dropdown-item py-2 text-danger" href="?r=auth/logout"><i class="fa fa-sign-out-alt me-2"></i> Logout</a></li>
            </ul>
          </li>
        <?php endif; ?>
        <!-- Dark Mode Toggle -->
