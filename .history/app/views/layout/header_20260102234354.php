      ...
      <ul class="navbar-nav mb-2 mb-lg-0 align-items-center gap-2">
        ...
        <?php if(!empty($_SESSION['user'])): ?>
          <?php
            ...
            $profilePic = !empty($currentUser['profile_picture']) ? htmlspecialchars($currentUser['profile_picture']) : 'https://ui-avatars.com/api/?name=' . urlencode($_SESSION['user']['full_name']) . '&size=32&background=0d6efd&color=fff';
          ?>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle d-flex align-items-center gap-1" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              <img src="<?=$profilePic?>" alt="Profile" class="navbar-profile-avatar">
