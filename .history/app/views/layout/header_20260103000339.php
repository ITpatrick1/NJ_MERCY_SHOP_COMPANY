            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
              <li class="dropdown-item-text">
                <div class="text-center py-2">
                  <img src="<?=$profilePic?>" alt="Profile" style="width: 60px; height: 60px; border-radius: 50%; margin-bottom: 8px;">
                  <div class="fw-bold"><?=htmlspecialchars($_SESSION['user']['full_name'])?></div>
                  <small class="text-muted"><?=htmlspecialchars($_SESSION['user']['role'])?></small>
                </div>
              </li>
              <li><hr class="dropdown-divider"></li>
              <li><a class="dropdown-item" href="?r=profile/index"><i class="fa fa-user-circle text-primary"></i> My Profile</a></li>
              <li><a class="dropdown-item" href="?r=profile/edit"><i class="fa fa-user-edit text-success"></i> Edit Profile</a></li>
              <li><hr class="dropdown-divider"></li>
