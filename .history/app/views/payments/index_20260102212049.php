...
.stats-card-payment:hover {
  transform: translateY(-5px);
}

.stats-card-payment.primary {
  background: linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%);
  color: white;
}

.stats-card-payment.primary:hover {
  box-shadow: 0 12px 24px rgba(59, 130, 246, 0.4);
}

.stats-card-payment.warning {
  background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%);
  color: white;
}

.stats-card-payment.warning:hover {
  box-shadow: 0 12px 24px rgba(245, 158, 11, 0.4);
}

.stats-card-payment.success {
  background: linear-gradient(135deg, #10b981 0%, #059669 100%);
  color: white;
}

.stats-card-payment.success:hover {
  box-shadow: 0 12px 24px rgba(16, 185, 129, 0.4);
}

.stats-card-payment.danger {
  background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%);
  color: white;
}

.stats-card-payment.danger:hover {
  box-shadow: 0 12px 24px rgba(239, 68, 68, 0.4);
}

/* Dark mode stats cards */
body.dark-mode .stats-card-payment.primary {
  background: linear-gradient(135deg, #1e3a8a 0%, #1e40af 100%) !important;
  box-shadow: 0 8px 24px rgba(30, 58, 138, 0.5) !important;
}

body.dark-mode .stats-card-payment.primary:hover {
  box-shadow: 0 12px 24px rgba(30, 58, 138, 0.6) !important;
}

body.dark-mode .stats-card-payment.warning {
  background: linear-gradient(135deg, #92400e 0%, #b45309 100%) !important;
  box-shadow: 0 8px 24px rgba(146, 64, 14, 0.5) !important;
}

body.dark-mode .stats-card-payment.warning:hover {
  box-shadow: 0 12px 24px rgba(146, 64, 14, 0.6) !important;
}

body.dark-mode .stats-card-payment.success {
  background: linear-gradient(135deg, #064e3b 0%, #065f46 100%) !important;
  box-shadow: 0 8px 24px rgba(6, 78, 59, 0.5) !important;
}

body.dark-mode .stats-card-payment.success:hover {
  box-shadow: 0 12px 24px rgba(6, 78, 59, 0.6) !important;
}

body.dark-mode .stats-card-payment.danger {
  background: linear-gradient(135deg, #7f1d1d 0%, #991b1b 100%) !important;
  box-shadow: 0 8px 24px rgba(127, 29, 29, 0.5) !important;
}

body.dark-mode .stats-card-payment.danger:hover {
  box-shadow: 0 12px 24px rgba(127, 29, 29, 0.6) !important;
}

body.dark-mode .stats-card-payment .text-muted {
...
<div class="container mt-4">
  ...
  <div class="row g-3 mb-4">
    ...
    ?>
    <div class="col-md-3">
      <div class="card stats-card-payment primary text-center border-0 shadow-sm h-100">
        <div class="card-body">
          <div class="mb-2"><i class="fa fa-file-invoice-dollar fa-2x"></i></div>
    ...
    <div class="col-md-3">
      <div class="card stats-card-payment warning text-center border-0 shadow-sm h-100">
        <div class="card-body">
    ...
    <div class="col-md-3">
      <div class="card stats-card-payment success text-center border-0 shadow-sm h-100">
        <div class="card-body">
    ...
    <div class="col-md-3">
      <div class="card stats-card-payment danger text-center border-0 shadow-sm h-100">
        <div class="card-body">
          <div class="mb-2"><i class="fa fa-times-circle fa-2x"></i></div>
                    ...
                    <div class="modal fade" id="rejectModal<?=$payment['payment_id']?>" tabindex="-1">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form method="POST" action="?r=payment/reject" id="rejectForm<?=$payment['payment_id']?>" data-validate-form>
                            <div class="modal-header bg-danger text-white">
                              <h5 class="modal-title"><i class="fa fa-times-circle"></i> Reject Payment #<?=$payment['payment_id']?></h5>
                            ...
                            <div class="modal-body">
                              ...
                              <input type="hidden" name="redirect" value="<?=$_SERVER['REQUEST_URI']?>">
                              <div class="mb-3">
                                <label class="form-label fw-600"><i class="fa fa-comment-dots"></i> Rejection Reason <span class="text-danger">*</span></label>
                                ...
                                <small class="text-muted"><i class="fa fa-info-circle"></i> Provide a clear reason (minimum 10 characters)</small>
                              </div>
                            </div>
